    ...
    <PageLayout>
      <div className="">
        ...
        <p className="mb-4 text-sm text-gray-500">
          Sağlığınızın detayları parmaklarınızın ucunda! Tahlillerim ekranında,
          tahlil raporlarınızı görüntüleyin ve Asistanıma Sor butonu ile AI
          tarafından anında analiz edilmesini sağlayın. Hızlı, güvenilir ve
          kolay bir şekilde sağlık durumunuz hakkında daha fazla bilgi edinin.
        </p>
